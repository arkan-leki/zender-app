...
const SaleForm = ({ sales, items, carts, deleteEvent, addGO,dashkan }) => {
    ...
    return (
        <div className="mx-auto" style={{ width: 700 + 'px' }}>
            {waslz.map((wasl, index) => (
                ...
                </div><div className="modal fade" id="dicount" tabIndex="-1" aria-hidden='true'>
